...
import { GraphMarketOverviewComponent } from './elements/dashboard/graph-market-overview/graph-market-overview.component';
import { GraphCurrentStatisticComponent } from './elements/dashboard/graph-current-statistic/graph-current-statistic.component';
import { SellOrderComponent } from './elements/dashboard/sell-order/sell-order.component';
import { BuyOrderComponent } from './elements/dashboard/buy-order/buy-order.component';
import { QuickTradeComponent } from './elements/dashboard/quick-trade/quick-trade.component';
import { RecentTradingActivitiesComponent } from './elements/dashboard/recent-trading-activities/recent-trading-activities.component';
...
import { CardSwiperComponent } from './elements/my-wallets/card-swiper/card-swiper.component';
import { WalleActivityComponent } from './elements/my-wallets/walle-activity/walle-activity.component';
import { CardDetailsComponent } from './elements/my-wallets/card-details/card-details.component';
import { GraphMainLimitsComponent } from './elements/my-wallets/card-details/graph-main-limits/graph-main-limits.component';
...
import { GraphCoinChartComponent } from './elements/my-wallets/graph-coin-chart/graph-coin-chart.component';

import { TransactionsComponent } from './transactions/transactions.component';

import { CoinDetailsComponent } from './coin-details/coin-details.component';
import { AboutComponent } from './elements/coin-details/about/about.component';
import { CoinChartComponent } from './elements/coin-details/coin-chart/coin-chart.component';
import { CoinDetailQuickTradeComponent } from './elements/coin-details/coin-detail-quick-trade/coin-detail-quick-trade.component';
import { CoinDetailSellOrderComponent } from './elements/coin-details/coin-detail-sell-order/coin-detail-sell-order.component';
import { CoinDetailBuyOrderComponent } from './elements/coin-details/coin-detail-buy-order/coin-detail-buy-order.component';

import { PortofolioComponent } from './portofolio/portofolio.component';
import { MyProfileComponent } from './elements/portofolio/my-profile/my-profile.component';
import { MyActivityComponent } from './elements/portofolio/my-activity/my-activity.component';
